...
public abstract class HolderListener<ADAPTER extends RecyclerView.Adapter, HOLDER extends RecyclerView.ViewHolder, MODEL>
        implements BaseHolderListener<HOLDER, MODEL> {

    public void beforeBind(ADAPTER adapter, HOLDER holder, MODEL item, int position) {
    }

    public void onBind(ADAPTER adapter, HOLDER holder, MODEL item, int position) {
    }
